...
const Home = (props) => {
  ...
  const updateAmount = (id, increment) => {
    ...
    return <div className='dark:text-white flex justify-center grid grid-cols-1 divide-y'>
      ...
      <p>Total: ${totalSum.toFixed(2)}</p>
        ...
        {props.userInfo && <DisplayAccount passUpInvoice={props.acceptInvoiceAndQuote} userInfo={props.userInfo} totalSum={totalSum}/>}
